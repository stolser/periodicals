 ...
 * </ul>
 */
public class MoreLessGame implements Game {
    private static final Logger LOGGER = LoggerFactory.getLogger(MoreLessGame.class);
    ...
    public void start() {
        ...
        LOGGER.debug("Starting a new MoreLessGame. Default range: {}...", currentRange);
