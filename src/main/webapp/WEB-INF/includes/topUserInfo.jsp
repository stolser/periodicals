...
<p class="text-right"><span class="userFullName"><c:out value="${currentUser.lastName}"/>
            <c:out value="${currentUser.firstName}"/></span>
    <a href="<c:url value="${ApplicationResources.CURRENT_USER_ACCOUNT_URI}"/>" class="btn btn-primary myAccountBtn" role="button">
